    ...
    public void initializeGlobalParams(){
        ...
        switch(params.getPlatformName()){
            case "Android":
                ...
                params.setDeviceName(System.getProperty("deviceName", "Android1"));
                params.setSystemPort(System.getProperty("systemPort", "10000"));
                params.setChromeDriverPort(System.getProperty("chromeDriverPort", "11000"));
                break;
            case "iOS":
                params.setUDID(System.getProperty("udid", "7565AACB-4F18-4372-9CB8-E68DCEEB9D2B"));
                params.setDeviceName(System.getProperty("deviceName", "iPhone 16e"));
